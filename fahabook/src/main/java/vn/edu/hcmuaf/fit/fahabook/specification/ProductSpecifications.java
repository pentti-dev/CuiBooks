package vn.edu.hcmuaf.fit.fahabook.specification;
...
public class ProductSpecifications {
    ...
    public static Specification<Product> detailContains(String detail) {
        return (root, query, cb) -> cb.like(cb.lower(root.get("detail")), "%" + detail.toLowerCase() + "%");
    }

    public static Specification<Product> supplierContains(String supplier) {
        return (root, query, cb) -> cb.like(cb.lower(root.get("supplier")), "%" + supplier.toLowerCase() + "%");
    }
    ...
    public static Specification<Product> publisherContains(String publisher) {
        return (root, query, cb) -> cb.like(cb.lower(root.get("publisher")), "%" + publisher.toLowerCase() + "%");
    }
    ...
    public static Specification<Product> sizeContains(String size) {
        return (root, query, cb) -> cb.like(cb.lower(root.get("size")), "%" + size.toLowerCase() + "%");
    }
